...
const ProfilePage = () => {
  ...
  const validateMobileNumber = (mobile) => {
    if (mobile === "") return true; // Empty number is valid
    const regex = /^\d{10}$/;
  ...
  return (
    <div className="w-screen h-screen sm:w-screen sm:h-screen md:w-screen md:h-screen lg:w-screen lg:h-screen flex items-center justify-center pt-5 pb-5 sm:p-0 ">
      <form
        ...
        className="bg-white-A700_33 gap-4 p-2 sm:pt-4 sm:pb-4 scroller relative w-4/12 h-full sm:w-full sm:h-full md:w-3/4 md:h-full lg:w-3/4 lg:h-full flex flex-col items-center justify-start md:justify-between md:pt-10 md:pb-10 sm:justify-between border-[1px] rounded-lg sm:rounded-none overflow-auto scroller"
      >
        <img
          src={APP_PATH + "images/2.png"}
          className="w-14 h-14 absolute top-0 right-0 rounded-full"
          alt=""
        />
        {isLoading && (
        ...
        <div className="relative -mt-2 sm:w-5/6 w-4/6 h-10 bg-gray-50 flex items-center justify-center  p-2 rounded-xl border-[1px] border-white-A700 green-border">
          ...
          <input
            name="name"
            className="w-full h-full bg-inherit border-none  "
            type="text"
        ...
        <div
          className={`relative sm:w-5/6 w-4/6 h-10 bg-gray-50 flex items-center justify-center  p-2 rounded-xl border-[1px] ${
            formErrors.phone ? "border-red-500" : "border-white-A700"
          }  green-border`}
        >
