...
const UserReports = () => {
  ...
  const getNoDataMessage = () => {
    switch (reportType) {
      case "approved":
        return "No approved posts found.";
      case "endorsed":
        return "No endorsed posts found.";
      case "unendorsed":
        return "No unendorsed posts found.";
      case "all":
  ...
  return (
    <div className="flex flex-col items-center p-4 md:p-6 space-y-8 overflow-x-auto">
      <div
        className="max-w-full border md:border-none p-4 md:p-6 rounded-lg"
