...
db.AttachOrg = require("./AttachedOrg")(sequelize, DataTypes);
...
db.users.hasMany(db.AttachOrg, { foreignKey: "UserId" }); // Assuming 'UserId' is the foreign key in the Post model
db.AttachOrg.belongsTo(db.users, { foreignKey: "UserId" });

db.Organisations.hasMany(db.AttachOrg, { foreignKey: "OrgId" }); // Assuming 'UserId' is the foreign key in the Post model
db.AttachOrg.belongsTo(db.Organisations, { foreignKey: "OrgId" });
